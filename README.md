...
Simple web UI to manage OpenVPN users, their certificates & routes in Linux. While backend is written in Go, frontend is based on Angular
...
Curently maintainted by [Archibald](archibald.picq@gmail.com).
